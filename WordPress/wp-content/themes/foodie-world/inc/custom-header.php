	...
	function foodie_world_header_media_text() {
		...
		<div class="custom-header-content">
			...
			<div class="entry-summary">
				...
				<span class="more-button"><a href="<?php echo esc_url( $header_media_url ); ?>" target="<?php echo get_theme_mod( 'foodie_world_header_url_target' ) ? '_blank' : '_self'; ?>" class="more-link"><?php echo esc_html( get_theme_mod( 'foodie_world_header_media_url_text' ) ); ?><span class="screen-reader-text"><?php echo wp_kses_post( get_theme_mod( 'foodie_world_header_media_title' ) ); ?></span></a></span>
				<?php endif; ?>
			</div>
		</div> <!-- entry-container -->
		<?php
